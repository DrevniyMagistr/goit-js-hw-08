...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const t="feedback-form-state",l={form:document.querySelector(".feedback-form"),email:document.querySelector('[name="email"]'),message:document.querySelector('[name="message"]')};let r={email:"",message:""};const m=e=>{r[e.target.name]=e.target.value,localStorage.setItem(t,JSON.stringify(r))},s=e=>{e.preventDefault(),l.email.value&&""!==l.message.value&&console.log(r),localStorage.removeItem(t),e.currentTarget.reset()},o=()=>{const e=JSON.parse(localStorage.getItem(t));null!==e&&(r=e,l.email.value=e.email?e.email:l.email.value,l.message.value=e.message?e.message:l.message.value)};l.form.addEventListener("submit",s),l.form.addEventListener("input",(0,e.default)(m,500)),o();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.b02354ce.js.map