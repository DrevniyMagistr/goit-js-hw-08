...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const t="feedback-form-state",l={form:document.querySelector(".feedback-form"),email:document.querySelector('[name="email"]'),message:document.querySelector('[name="message"]')},m={email:"",message:""},r=e=>{e.preventDefault(),l.email.value&&""!==l.message.value&&console.log(m),localStorage.removeItem(t),e.currentTarget.reset()},s=()=>{m.email=l.email.value,m.message=l.message.value,localStorage.setItem(t,JSON.stringify(m))},o=()=>{const e=localStorage.getItem(t),a=JSON.parse(e);null!==a&&(l.email.value=a.email,l.message.value=a.message)};l.form.addEventListener("submit",r),l.form.addEventListener("input",(0,e.default)(s,500)),o();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.d4fb6976.js.map